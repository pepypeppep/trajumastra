<section class="relative py-24 xl:py-32" id="bbi">
    ...
    <div class="container 2xl:max-w-[87.5rem] px-4 mx-auto">
        <div class="grid items-center grid-cols-1 gap-6 mt-0 lg:grid-cols-12">
            {{-- <div class="relative lg:col-span-6">
                ...
                <h1 class="mb-3 leading-normal capitalize" data-aos="fade-right" data-aos-delay="400">BBI (Balai Benih
                    Ikan)</h1>
                <p class="mb-5 text-lg text-slate-500 dark:text-zinc-400" data-aos="fade-right" data-aos-delay="500">
                    Unit atau lembaga yang berfungsi untuk memproduksi, mengelola, dan mendistribusikan benih ikan yang
                    berkualitas, biasanya dikelola oleh pemerintah daerah atau instansi perikanan.</p>
                <table id="rowBorder" class="hover-group dataTables" style="width:100%" data-aos="fade-right"
                    ...
                    <tbody class="divide-y divide-slate-200 dark:divide-zink-500">
                        @foreach ($bbis as $bbi)
                            <tr data-id={{ $bbi->id }} title="Klik untuk melihat data BBI {{ $bbi->name }}"
                                class="bbi-row cursor-pointer hover:bg-slate-200 dark:hover:bg-slate-100">
                                <td>{{ $bbi->name }}</td>
                                <td>{{ $bbi->address }}</td>
                            </tr>
                        @endforeach
            ...
            <div class="ml-auto lg:col-span-12 lg:col-start-12 w-full">
                ...
                <h1 class="mb-3 leading-normal capitalize" data-aos="fade-right" data-aos-delay="400">BBI (Balai Budidaya
                    Ikan)</h1>
                <p class="mb-5 text-lg text-slate-500 dark:text-zinc-400" data-aos="fade-left" data-aos-delay="500">
                    Berikut ini adalah peta sebaran data BBI</p>
                <div class="leaflet-map w-full" style="height: 35rem;" id="map-bbi"></div>
            </div><!--end col-->
        </div><!--end grid-->
    </div><!--end container-->
</section><!--end -->

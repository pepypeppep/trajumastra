    ...
    <div class="container 2xl:max-w-[87.5rem] px-4 mx-auto flex items-center self-center w-full">
        ...
        <div class="mx-auto">
            <ul id="navbar7"
                ...
                <li>
                    <a href="/#beranda"
                        class="@if (Route::currentRouteName() == 'index') active @else '' @endif block md:inline-block px-4 md:px-3 py-2.5 md:py-0.5 text-15 font-medium text-slate-800 transition-all duration-300 ease-linear hover:text-custom-500 [&.active]:text-custom-500 dark:text-zinc-200 dark:hover:text-custom-500 dark:[&.active]:text-custom-500">Beranda</a>
                </li>
                {{-- <li>
                    <a href="/#berita"
                ...
                <li>
                    <a href="/#jadwal-pendampingan"
                        class="block md:inline-block px-4 md:px-3 py-2.5 md:py-0.5 text-15 font-medium text-slate-800 transition-all duration-300 ease-linear hover:text-custom-500 [&.active]:text-custom-500 dark:text-zinc-200 dark:hover:text-custom-500 dark:[&.active]:text-custom-500">Jadwal
                        Pendampingan</a>
                </li>
                <li>
                    <a href="/#pelaku-usaha"
                ...
                <li>
                    <a href="{{ route('privacy-policy') }}"
                        class="@if (Route::currentRouteName() == 'privacy-policy') active @else '' @endif block md:inline-block px-4 md:px-3 py-2.5 md:py-0.5 text-15 font-medium text-slate-800 transition-all duration-300 ease-linear hover:text-custom-500 [&.active]:text-custom-500 dark:text-zinc-200 dark:hover:text-custom-500 dark:[&.active]:text-custom-500">Kebijakan Privasi</a>
                </li>

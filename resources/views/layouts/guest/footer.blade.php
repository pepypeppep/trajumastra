<footer class="relative pt-20 pb-12 border-t border-slate-200 dark:border-zinc-800">
    ...
    <div class="container 2xl:max-w-[87.5rem] px-4 mx-auto flex items-center justify-center">
        <div class="relative z-10 grid grid-cols-12 gap-5 xl:grid-cols-12">
            <div class="col-span-12 md:col-span-12 lg:col-span-12 xl:col-span-12">
                ...
                <h3 class="mt-5 dark:text-zinc-400  flex items-center justify-center">Dinas Kelautan dan
                    Perikanan Kabupaten Bantul</h3>
                <p class="mb-5 text-slate-500 dark:text-zinc-400">Komplek Perkantoran Terpadu Pemda II, Jl. Lingkar
                    Timur Manding Trirenggo Bantul Kabupaten Bantul, Daerah Istimewa Yogyakarta 55714</p>

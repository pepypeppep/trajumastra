                    ...
                    <div class="relative flex items-center dropdown h-header">
                        <button type="button"
                            ...
                            @switch(Session::get('lang'))
                                @case('ru')
                                    <img src="{{ URL::asset('assets/images/flags/20/ru.svg') }}" alt=""
                                        id="header-lang-img" class="h-5 rounded-sm">
                                @break

                                @case('it')
                                    <img src="{{ URL::asset('assets/images/flags/20/it.svg') }}" alt=""
                                        id="header-lang-img" class="h-5 rounded-sm">
                                @break

                                @case('sp')
                                    <img src="{{ URL::asset('assets/images/flags/20/es.svg') }}" alt=""
                                        id="header-lang-img" class="h-5 rounded-sm">
                                @break

                                @case('ch')
                                    <img src="{{ URL::asset('assets/images/flags/20/china.svg') }}" alt=""
                                        id="header-lang-img" class="h-5 rounded-sm">
                                @break

                                @case('fr')
                                    <img src="{{ URL::asset('assets/images/flags/20/fr.svg') }}" alt=""
                                        id="header-lang-img" class="h-5 rounded-sm">
                                @break

                                @case('gr')
                                    <img src="{{ URL::asset('assets/images/flags/20/de.svg') }}" alt=""
                                        id="header-lang-img" class="h-5 rounded-sm">
                                @break

                                @case('ar')
                                    <img src="{{ URL::asset('assets/images/flags/20/ae.svg') }}" alt=""
                                        id="header-lang-img" class="h-5 rounded-sm">
                                @break

                                @case('jp')
                                    <img src="{{ URL::asset('assets/images/flags/20/jp.svg') }}" alt=""
                                        id="header-lang-img" class="h-5 rounded-sm">
                                @break

                                @default
                                    <img src="{{ URL::asset('assets/images/flags/20/us.svg') }}" alt=""
                                        id="header-lang-img" class="h-5 rounded-sm">
                            @endswitch
                        </button>
                                ...
                                <div class="flex flex-col gap-1" id="notification-list">
                                    <a href="#!"
                                        ...
                                        <div class="w-10 h-10 rounded-md shrink-0 bg-slate-100">
                                            <img src="{{ URL::asset('assets/images/users/avatar-3.png') }}"
                                    ...
                                    <a href="#!"
                                        ...
                                        <div class="w-10 h-10 bg-yellow-100 rounded-md shrink-0">
                                            <img src="{{ URL::asset('assets/images/users/avatar-5.png') }}"
                                                alt="" class="rounded-md">
                                        </div>
                                        <div class="grow">
                                    ...
                                    <a href="#!"
                                        ...
                                        <div class="relative shrink-0">
                                            <div class="w-10 h-10 bg-pink-100 rounded-md">
                                                <img src="{{ URL::asset('assets/images/users/avatar-7.png') }}"
                                                    alt="" class="rounded-md">
                                            </div>
        ...
        <div class="h-[calc(100vh_-_370px)] p-4 overflow-y-auto product-list">
            <div class="flex flex-col gap-4">
                ...
                <div class="flex gap-2 product">
                    <div
                        class="flex items-center justify-center w-12 h-12 rounded-md bg-slate-100 shrink-0 dark:bg-zink-500">
                        <img src="{{ URL::asset('assets/images/product/img-03.png') }}" alt=""
                            class="h-8">
                    </div>
                    <div class="overflow-hidden grow">
                        <div class="ltr:float-right rtl:float-left">
                ...
                <div class="flex gap-2 product">
                    <div
                        class="flex items-center justify-center w-12 h-12 rounded-md bg-slate-100 shrink-0 dark:bg-zink-500">
                        <img src="{{ URL::asset('assets/images/product/img-09.png') }}" alt=""
                            class="h-8">
                    </div>
                    <div class="overflow-hidden grow">
                        <div class="ltr:float-right rtl:float-left">

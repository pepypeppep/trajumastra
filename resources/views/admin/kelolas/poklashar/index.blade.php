...
@section('title', 'Kelola Poklashar')

@section('breadcrumb')
    {{ Breadcrumbs::render('kelola.poklashar') }}
@endsection
...
@section('content-admin')
    <div class="card">
        <div class="card-body">
            ...
            <table id="data-table" class="display stripe group" style="width:100%">
                <thead>
                    <tr>
                        <th class="ltr:!text-left rtl:!text-right">Nama Poklashar</th>
    ...
    {{-- Modal Add --}}
    @include('admin.kelolas.poklashar.partials.modal-add')
    {{-- Modal Edit --}}
    @include('admin.kelolas.poklashar.partials.modal-edit')
    {{-- Form Delete --}}
    ...
    <script>
        ...
        function loadTable(filter) {
            var tbl = $('#data-table').DataTable({
                ...
                ajax: {
                    url: "{{ route('kelola.poklashar.index') }}",
                    type: 'GET',
                },
                columns: [{
                        data: 'name',

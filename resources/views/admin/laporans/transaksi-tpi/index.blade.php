...
@section('title', 'Transaksi TPI')

@section('breadcrumb')
    {{ Breadcrumbs::render('laporan.transaksi-tpi') }}
@endsection
...
@section('content-admin')
    <div class="grid grid-cols-12 2xl:grid-cols-12 gap-x-5">
        ...
        <div class="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-3 cursor-pointer"
            onclick="location.href='/laporan/transaksi-tpi'">
            <div class="card-body">
                <div class="mt-4 mb-6 text-center">
    ...
    {{-- Modal Show --}}
    @include('admin.laporans.transaksi-tpi.partials.modal-show')
@endsection

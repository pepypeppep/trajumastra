<div id="modal-add-menu" modal-center
    ...
    <div
        ...
        <div
            ...
            <h5 class="text-16" id="modal-title">Tambah Menu Baru</h5>
            <button data-modal-close="modal-add-menu"
                class="transition-all duration-200 ease-linear text-slate-500 hover:text-red-500 dark:text-zink-200 dark:hover:text-red-500"><i
                    data-lucide="x" class="size-5"></i></button>
        </div>
        <form action="{{ route('settings.navs.store') }}" method="POST" id="form-add-menu">
            {{-- CSRF Token --}}
            @csrf
            {{-- Start Modal Body --}}

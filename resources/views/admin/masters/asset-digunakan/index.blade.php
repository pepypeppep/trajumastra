...
<div class="card">
    <div class="card-body">
        <div class="flex justify-between items-center mb-4">
            <h5 class="mb-0">Daftar Asset Digunakan</h5>
            <button type="button" href="" data-modal-target="modal-add"
                ...
                <i class="ri-user-add-line"></i> Tambah Asset Digunakan
            </button>
        </div>
...
{{-- Modal Add --}}
@include('admin.masters.asset-digunakan.partials.modal-add')
{{-- Modal Edit --}}
@include('admin.masters.asset-digunakan.partials.modal-edit')
{{-- Form Delete --}}
    ...
    <script>
        ...
        function loadTable(filter) {
            var tbl = $('#data-table').DataTable({
                ...
                ajax: {
                    url: "{{ route('master.asset-digunakan.index') }}",
                    type: 'GET',
                },
                columns: [{
                        data: 'name',

...
@section('breadcrumb')
    {{ Breadcrumbs::render('master.bidang') }}
@endsection
    ...
    <div class="card-body">
        <div class="flex justify-between items-center mb-4">
            ...
            <button type="button" href="" data-modal-target="modal-add"
                ...
                <i class="ri-user-add-line"></i> Tambah Bidang
            </button>
        </div>
        <table id="data-table" class="display stripe group" style="width:100%">
            <thead>
                <tr>
                    <th class="ltr:!text-left rtl:!text-right">Nama Bidang</th>
...
{{-- Modal Add --}}
@include('admin.masters.bidang.partials.modal-add')
{{-- Modal Edit --}}
@include('admin.masters.bidang.partials.modal-edit')
{{-- Form Delete --}}

...
@section('breadcrumb')
    {{ Breadcrumbs::render('master.jenis-transaksi') }}
@endsection
...
@section('content-admin')
    <div class="card">
        <div class="card-body">
            <div class="flex justify-between items-center mb-4">
                <h5 class="mb-0">Daftar Jenis Transaksi</h5>
                <button type="button" href="" data-modal-target="modal-add"
                    ...
                    <i class="ri-user-add-line"></i> Tambah Jenis Transaksi
                </button>
            </div>
    ...
    {{-- Modal Add User --}}
    @include('admin.masters.jenis-transaksi.partials.modal-add')
    {{-- Modal Edit User --}}
    @include('admin.masters.jenis-transaksi.partials.modal-edit')
    {{-- Form Delete --}}
    ...
    <script>
        ...
        function loadTable(filter) {
            var tbl = $('#data-table').DataTable({
                ...
                ajax: {
                    url: "{{ route('master.jenis-transaksi.index') }}",
                    type: 'GET',
                },
                columns: [{
                        data: 'name',

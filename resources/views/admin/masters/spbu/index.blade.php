...
@section('breadcrumb')
    {{ Breadcrumbs::render('master.spbu') }}
@endsection
...
@section('content-admin')
        ...
        <div class="card-body">
            <div class="flex justify-between items-center mb-4">
                ...
                <button type="button" href="" data-modal-target="modal-add"
                    ...
                    <i class="ri-user-add-line"></i> Tambah SPBU
                </button>
            </div>
    ...
    {{-- Modal Add --}}
    @include('admin.masters.spbu.partials.modal-add')
    {{-- Modal Edit --}}
    @include('admin.masters.spbu.partials.modal-edit')
    {{-- Form Delete --}}

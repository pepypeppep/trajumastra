...
@section('content-admin')
    <div class="card">
        <div class="card-body">
            <div class="flex justify-between items-center mb-4">
                <h5 class="mb-0">Daftar Jenis KlasifikasiUsaha</h5>
                <button type="button" href="" data-modal-target="modal-add"
                    ...
                    <i class="ri-user-add-line"></i> Tambah Jenis KlasifikasiUsaha
                </button>
            </div>
    ...
    {{-- Modal Add User --}}
    @include('admin.masters.jenis-klasifikasi-usaha.partials.modal-add')
    {{-- Modal Edit User --}}
    @include('admin.masters.jenis-klasifikasi-usaha.partials.modal-edit')
    {{-- Form Delete --}}
    ...
    <script>
        ...
        function loadTable(filter) {
            var tbl = $('#data-table').DataTable({
                ...
                ajax: {
                    url: "{{ route('master.jenis-klasifikasi-usaha.index') }}",
                    type: 'GET',
                },
                columns: [{
                        data: 'name',

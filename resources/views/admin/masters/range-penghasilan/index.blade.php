...
@section('title', 'Range Penghasilan')

@section('breadcrumb')
    {{ Breadcrumbs::render('master.range-penghasilan') }}
@endsection
...
<div class="card">
    <div class="card-body">
        <div class="flex justify-between items-center mb-4">
            <h5 class="mb-0">Daftar Range Penghasilan</h5>
            <button type="button" href="" data-modal-target="modal-add"
                ...
                <i class="ri-user-add-line"></i> Tambah Range Penghasilan
            </button>
        </div>
        <table id="data-table" class="display stripe group" style="width:100%">
            <thead>
                <tr>
                    <th class="ltr:!text-left rtl:!text-right">Range Penghasilan</th>
...
{{-- Modal Add --}}
@include('admin.masters.range-penghasilan.partials.modal-add')
{{-- Modal Edit --}}
@include('admin.masters.range-penghasilan.partials.modal-edit')
{{-- Form Delete --}}
    ...
    <script>
        ...
        function loadTable(filter) {
            var tbl = $('#data-table').DataTable({
                ...
                ajax: {
                    url: "{{ route('master.range-penghasilan.index') }}",
                    type: 'GET',
                },
                columns: [{
                        data: 'name',

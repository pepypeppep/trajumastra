...
@section('breadcrumb')
    {{ Breadcrumbs::render('master.jenis-usaha') }}
@endsection
...
@section('content-admin')
    <div class="card">
        <div class="card-body">
            <div class="flex justify-between items-center mb-4">
                <h5 class="mb-0">Daftar Jenis Usaha</h5>
                <button type="button" href="" data-modal-target="modal-add"
                    ...
                    <i class="ri-user-add-line"></i> Tambah Jenis Usaha
                </button>
            </div>
            <table id="data-table" class="display stripe group" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th class="ltr:!text-left rtl:!text-right">Kelompok</th>
    ...
    {{-- Modal Add --}}
    @include('admin.masters.jenis-usaha.partials.modal-add')
    {{-- Modal Edit --}}
    @include('admin.masters.jenis-usaha.partials.modal-edit')
    {{-- Form Delete --}}
...
@push('scripts')
    ...
    <script>
        ...
        function initSelect2(context) {
            $(context).find('[name="category_group_name"]').select2({
    ...
    <script>
        ...
        function loadTable(filter) {
            var tbl = $('#data-table').DataTable({
                ...
                ajax: {
                    url: "{{ route('master.jenis-usaha.index') }}",
                    type: 'GET',
                },
                columns: [{
                        data: 'name',

...
@section('title', 'Jenis Asset')

@section('breadcrumb')
    {{ Breadcrumbs::render('master.jenis-asset') }}
@endsection
...
<div class="card">
    <div class="card-body">
        <div class="flex justify-between items-center mb-4">
            <h5 class="mb-0">Daftar Jenis Asset</h5>
            <button type="button" href="" data-modal-target="modal-add"
                ...
                <i class="ri-user-add-line"></i> Tambah Jenis Asset
            </button>
        </div>
        <table id="data-table" class="display stripe group" style="width:100%">
            <thead>
                <tr>
                    <th class="ltr:!text-left rtl:!text-right">Nama Jenis Asset</th>
...
{{-- Modal Add --}}
@include('admin.masters.jenis-asset.partials.modal-add')
{{-- Modal Edit --}}
@include('admin.masters.jenis-asset.partials.modal-edit')
{{-- Form Delete --}}
    ...
    <script>
        ...
        function loadTable(filter) {
            var tbl = $('#data-table').DataTable({
                ...
                ajax: {
                    url: "{{ route('master.jenis-asset.index') }}",
                    type: 'GET',
                },
                columns: [{
                        data: 'name',

...
@section('title', 'Bentuk Usaha')

@section('breadcrumb')
    {{ Breadcrumbs::render('master.bentuk-usaha') }}
@endsection
...
<div class="card">
    <div class="card-body">
        <div class="flex justify-between items-center mb-4">
            <h5 class="mb-0">Daftar Bentuk Usaha</h5>
            <button type="button" href="" data-modal-target="modal-add"
                ...
                <i class="ri-user-add-line"></i> Tambah Bentuk Usaha
            </button>
        </div>
...
{{-- Modal Add --}}
@include('admin.masters.bentuk-usaha.partials.modal-add')
{{-- Modal Edit --}}
@include('admin.masters.bentuk-usaha.partials.modal-edit')
{{-- Form Delete --}}
    ...
    <script>
        ...
        function loadTable(filter) {
            var tbl = $('#data-table').DataTable({
                ...
                ajax: {
                    url: "{{ route('master.bentuk-usaha.index') }}",
                    type: 'GET',
                },
                columns: [{
                        data: 'name',

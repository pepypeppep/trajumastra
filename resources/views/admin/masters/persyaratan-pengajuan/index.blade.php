    ...
    <div class="card">
        <div class="card-body">
            <div class="flex justify-between items-center mb-4">
                <h5 class="mb-0">Daftar Syarat BBM</h5>
                <button type="button" href="" data-modal-target="modal-add"
                    ...
                    <i class="ri-user-add-line"></i> Tambah Syarat BBM
                </button>
            </div>
            <table id="data-table" class="display stripe group" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th class="ltr:!text-left rtl:!text-right">Tipe</th>
    ...
    <script>
        ...
        function loadTable(filter) {
            var tbl = $('#data-table').DataTable({
                ...
                ajax: {
                    url: "{{ route('master.persyaratan-pengajuan.index') }}",
                    type: 'GET',
                },
                columns: [{
                        data: 'name',

...
@section('title', 'Kelola Jenis Penyuluhan')

@section('breadcrumb')
    {{ Breadcrumbs::render('master.jenis-penyuluhan') }}
@endsection
...
<div class="card">
    <div class="card-body">
        <div class="flex justify-between items-center mb-4">
            <h5 class="mb-0">Daftar Jenis Penyuluhan</h5>
            <button type="button" href="" data-modal-target="modal-add"
                ...
                <i class="ri-user-add-line"></i> Tambah Jenis Penyuluhan
            </button>
        </div>
...
{{-- Modal Add --}}
@include('admin.masters.jenis-penyuluhan.partials.modal-add')
{{-- Modal Edit --}}
@include('admin.masters.jenis-penyuluhan.partials.modal-edit')
{{-- Form Delete --}}
    ...
    <script>
        ...
        function loadTable(filter) {
            var tbl = $('#data-table').DataTable({
                ...
                ajax: {
                    url: "{{ route('master.jenis-penyuluhan.index') }}",
                    type: 'GET',
                },
                columns: [{
                        data: 'name',

...
@section('title', 'Jenis Usaha Sarana')

@section('breadcrumb')
    {{ Breadcrumbs::render('master.jenis-usaha-sarana') }}
@endsection
...
@section('content-admin')
    <div class="card">
        <div class="card-body">
            <div class="flex justify-between items-center mb-4">
                <h5 class="mb-0">Daftar Jenis Usaha Sarana</h5>
                <button type="button" href="" data-modal-target="modal-add"
                    ...
                    <i class="ri-user-add-line"></i> Tambah Jenis Usaha Sarana
                </button>
            </div>
    ...
    {{-- Modal Add --}}
    @include('admin.masters.jenis-usaha-sarana.partials.modal-add')
    {{-- Modal Edit --}}
    @include('admin.masters.jenis-usaha-sarana.partials.modal-edit')
    {{-- Form Delete --}}
    ...
    <script>
        ...
        function loadTable(filter) {
            var tbl = $('#data-table').DataTable({
                ...
                ajax: {
                    url: "{{ route('master.jenis-usaha-sarana.index') }}",
                    type: 'GET',
                },
                columns: [{
                        data: 'name',

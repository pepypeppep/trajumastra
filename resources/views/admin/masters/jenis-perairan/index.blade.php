...
@section('content-admin')
    <div class="card">
        <div class="card-body">
            <div class="flex justify-between items-center mb-4">
                <h5 class="mb-0">Daftar Jenis Perairan</h5>
                <button type="button" href="" data-modal-target="modal-add"
                    ...
                    <i class="ri-user-add-line"></i> Tambah Jenis Perairan
                </button>
            </div>
    ...
    {{-- Modal Add User --}}
    @include('admin.masters.jenis-perairan.partials.modal-add')
    {{-- Modal Edit User --}}
    @include('admin.masters.jenis-perairan.partials.modal-edit')
    {{-- Form Delete --}}
    ...
    <script>
        ...
        function loadTable(filter) {
            var tbl = $('#data-table').DataTable({
                ...
                ajax: {
                    url: "{{ route('master.jenis-perairan.index') }}",
                    type: 'GET',
                },
                columns: [{
                        data: 'name',
    ...
    <script>
        $(document).on('click', '#btn-delete-user', function(e) {
            ...
            Swal.fire({
                ...
                text: "Data tidak bisa dikembalperairan setelah dihapus!",
                icon: 'warning',

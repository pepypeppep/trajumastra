        ...
        return DataTables::eloquent($data)
            ...
            ->addColumn('aksi', function ($row) {
                ...
                if (auth()->user()->can('perahu.update')) {
                    $btnEdit = '<button href="javascript:void(0);" title="Ubah data perahu" id="btn-modal-edit"
                ...
                if (auth()->user()->can('perahu.delete')) {
                    $btnDelete = '<button href="javascript:void(0);" title="Hapus data perahu" id="btn-delete" onclick="confirmDelete(this)"

        ...
        return DataTables::eloquent($data)
            ...
            ->addColumn('aksi', function ($row) {
                ...
                if (auth()->user()->can('persyaratan-pengajuan.update')) {
                    $btnEdit = '<button type="button" title="Ubah data syarat bbm" id="btn-modal-edit"
                ...
                if (auth()->user()->can('persyaratan-pengajuan.delete')) {
                    $btnDelete = '<button type="button" title="Hapus data syarat bbm" id="btn-delete" onclick="confirmDelete(this)"

        ...
        return DataTables::eloquent($data)
            ...
            ->addColumn('aksi', function ($row) {
                ...
                if (auth()->user()->can('spbu.update')) {
                    $btnEdit = '<button type="button" title="Ubah data spbu" id="btn-modal-edit"
                ...
                if (auth()->user()->can('spbu.delete')) {
                    $btnDelete = '<button type="button" title="Hapus data spbu" id="btn-delete" onclick="confirmDelete(this)"

        ...
        return DataTables::eloquent($data)
            ...
            ->addColumn('aksi', function ($row) {
                ...
                if (auth()->user()->can('spbu.update')) {
                    $btnEdit = '<button href="javascript:void(0);" title="Edit data spbu" id="btn-modal-edit-user"
                ...
                if (auth()->user()->can('spbu.delete')) {
                    $btnDelete = '<button href="javascript:void(0);" title="Hapus data spbu" id="btn-delete-user" onclick="confirmDelete(this)"

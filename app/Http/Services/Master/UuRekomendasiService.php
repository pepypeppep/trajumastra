        ...
        return DataTables::eloquent($data)
            ...
            ->addColumn('aksi', function ($row) {
                ...
                if (auth()->user()->can('uu-rekomendasi.update')) {
                    $btnEdit = '<button type="button" title="Ubah data uu rekomendasi bbm" id="btn-modal-edit"
                ...
                if (auth()->user()->can('uu-rekomendasi.delete')) {
                    $btnDelete = '<button type="button" title="Hapus data uu rekomendasi bbm" id="btn-delete" onclick="confirmDelete(this)"

        ...
        return DataTables::eloquent($data)
            ...
            ->addColumn('aksi', function ($row) {
                ...
                if (auth()->user()->can('kelola-pokmaswas.update')) {
                    $btnEdit = '<button type="button" title="Ubah data Pokmaswas" id="btn-modal-edit"
                ...
                if (auth()->user()->can('kelola-pokmaswas.delete')) {
                    $btnDelete = '<button type="button" title="Hapus data Pokmaswas" id="btn-delete" onclick="confirmDelete(this)"

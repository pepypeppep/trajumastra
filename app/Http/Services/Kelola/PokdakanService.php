        ...
        return DataTables::eloquent($data)
            ...
            ->addColumn('aksi', function ($row) {
                ...
                if (auth()->user()->can('kelola-pokdakan.update')) {
                    $btnEdit = '<button type="button" title="Ubah data pokdakan" id="btn-modal-edit"
                ...
                if (auth()->user()->can('kelola-pokdakan.delete')) {
                    $btnDelete = '<button type="button" title="Hapus data pokdakan" id="btn-delete" onclick="confirmDelete(this)"

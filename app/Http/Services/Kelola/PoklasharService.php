        ...
        return DataTables::eloquent($data)
            ...
            ->addColumn('aksi', function ($row) {
                ...
                if (auth()->user()->can('kelola-poklashar.update')) {
                    $btnEdit = '<button type="button" title="Ubah data Poklashar" id="btn-modal-edit"
                ...
                if (auth()->user()->can('kelola-poklashar.delete')) {
                    $btnDelete = '<button type="button" title="Hapus data Poklashar" id="btn-delete" onclick="confirmDelete(this)"

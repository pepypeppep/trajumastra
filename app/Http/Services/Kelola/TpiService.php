        ...
        return DataTables::eloquent($data)
            ...
            ->addColumn('aksi', function ($row) {
                ...
                if (auth()->user()->can('kelola-tpi.update')) {
                    $btnEdit = '<button type="button" title="Ubah data tpi" id="btn-modal-edit"
                ...
                if (auth()->user()->can('kelola-tpi.delete')) {
                    $btnDelete = '<button type="button" title="Hapus data tpi" id="btn-delete" onclick="confirmDelete(this)"

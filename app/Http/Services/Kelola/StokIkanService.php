        ...
        return DataTables::eloquent($data)
            ...
            ->addColumn('aksi', function ($row) {
                ...
                if (auth()->user()->can('kelola-stok-ikan.update')) {
                    $btnEdit = '<button type="button" title="Ubah data stok ikan" id="btn-modal-edit"
                ...
                if (auth()->user()->can('kelola-stok-ikan.delete')) {
                    $btnDelete = '<button type="button" title="Hapus data stok ikan" id="btn-delete" onclick="confirmDelete(this)"
